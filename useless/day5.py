...
while running:
    ...
    mode_text = font.render(f"Mode: {GAME_MODE}", True, 
                          (100, 200, 255) if GAME_MODE == "COUNTING" else (100, 255, 150))
    screen.blit(mode_text, (WIDTH - 310, 40))
    
    # Draw problem with better styling
